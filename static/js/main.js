...
$(document).ready(function () {
    ...
    /*==============================================================*/
    //solution contents  - START CODE
    /*==============================================================*/

	$('#solution .TabArea li').click(function(){
		var idx = $(this).index();
	
		$('#solution .TabArea li').removeClass('on');
		$(this).addClass('on');
		$('.solution_wrap .solution_con').hide();
		$('.solution_wrap .solution_con').eq(idx).show();
	})

    /*==============================================================*/
    //solution contents  - END CODE
    /*==============================================================*/
